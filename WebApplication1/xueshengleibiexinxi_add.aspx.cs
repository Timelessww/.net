...
namespace 学生宿舍管理系统
{
    public partial class xueshengleibiexinxi_add : System.Web.UI.Page
    {
        ...
        {
            string sql;
            sql = "insert into xueshengleibiexinxi(xueshengleibie) values('" + xueshengleibie.Text.ToString().Trim() + "') ";
            int result;
