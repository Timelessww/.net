...
namespace 学生宿舍管理系统
{
    public partial class bumenxinxi_add : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string sql;
            sql = "insert into bumenxinxi(bumen,zhuguan) values('" + bumen.Text.ToString().Trim() + "','" + zhuguan.Text.ToString().Trim() + "') ";
            int result;
