<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wupinxinxi_add.aspx.cs" Inherits="学生宿舍管理系统.wupinxinxi_add" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellspacing="0" borderColorDark="#9cc7ef" cellpadding="4" width="100%" align="center"
				...
				<tr bgcolor="#4296e7">
					<td colspan="2">
						<div align="center"><font color="#ffffff">添加物品信息</font></div>
					</td>
				</tr>
