<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gg_add.aspx.cs" Inherits="学生宿舍管理系统.gg_add" %>
                ...
                <table bgcolor="#fbd79f" border="0" cellpadding="0" cellspacing="1" height="280"
                    ...
                    <tr>
                        ...
                        <td align="left" bgcolor="#fff5e1" colspan="3" style="height: 353px" valign="top">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" Height="84px" Width="254px"></asp:TextBox>
