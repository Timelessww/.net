<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="weijijilu_add.aspx.cs" Inherits="学生宿舍管理系统.weijijilu_add" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellspacing="0" borderColorDark="#9cc7ef" cellpadding="4" width="100%" align="center"
				...
				<tr bgcolor="#4296e7">
					<td colspan="2">
						<div align="center"><font color="#ffffff">添加违纪记录</font></div>
					</td>
				</tr>
