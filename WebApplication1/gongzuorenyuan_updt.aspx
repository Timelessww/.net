<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gongzuorenyuan_updt.aspx.cs" Inherits="学生宿舍管理系统.gongzuorenyuan_updt" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellspacing="0" borderColorDark="#9cc7ef" cellpadding="4" width="100%" align="center"
				...
				<tr bgcolor="#4296e7">
					<td colspan="2">
						<div align="center"><font color="#ffffff">修改工作人员</font></div>
					</td>
				</tr>
