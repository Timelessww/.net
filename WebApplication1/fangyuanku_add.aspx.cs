...
namespace 学生宿舍管理系统
{
    public partial class fangyuanku_add : System.Web.UI.Page
    {
        ...
        {
            string sql;
            sql = "insert into fangyuanku(loufangbianhao,leixing) values('" + loufangbianhao.Text.ToString().Trim() + "','" + leixing.Text.ToString().Trim() + "') ";
            int result;
